...
{if(this._canvas||this._vimage||this._img){var angle=this._parameters.easing(0,actualTime-this._animateStartTime,this._animateStartAngle,this._parameters.animateTo-this._animateStartAngle,this._parameters.duration);this._rotate((~~(angle*100))/100);}
...
return function(angle){this._angle=angle;this._img.style[supportedCSS]="rotate("+(angle)+"deg) translate(-50%,-50%)";}})()}})(jQuery);
